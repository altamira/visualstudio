...
create procedure pr_valorpedido_valorinvoice_frete
...
as
 ...
 from #ValoresPedido,(select ValorInvoice, Frete, Ano, Mes 
                    from #ValoresInvoice) as ValoresInvoice
 where #ValoresPedido.Frete=ValoresInvoice.Frete and
...
--------------------------------------------------------------------------
--exec pr_valorpedido_valorinvoice_frete '11/01/2004','01/31/2005',4 --4=Iene
