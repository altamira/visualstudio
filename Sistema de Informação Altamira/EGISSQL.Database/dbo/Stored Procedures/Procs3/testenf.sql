--drop procedure testenf
create procedure testenf
@cd_rc int
as
	...
	from 
	  ...
	  left outer join fornecedor_informacao_compra fic on fic.cd_fornecedor = fp.cd_fornecedor
	 ...
	 where
	      ...
	      and rc.cd_requisicao_compra = @cd_rc 	
