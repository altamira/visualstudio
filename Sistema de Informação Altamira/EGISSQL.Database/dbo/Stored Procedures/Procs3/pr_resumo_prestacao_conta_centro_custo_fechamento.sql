...
-------------------------------------------------------------------------------
--sp_helptext pr_resumo_prestacao_conta_centro_custo_fechamento
-------------------------------------------------------------------------------
--pr_resumo_prestacao_conta_centro_custo_fechamento
-------------------------------------------------------------------------------
...
------------------------------------------------------------------------------
create procedure pr_resumo_prestacao_conta_centro_custo_fechamento
...
select
  @vl_total_prestacao = sum( isnull(vl_prestacao,0) )
from
  #ResumoCentroCusto
