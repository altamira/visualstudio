...
-------------------------------------------------------------------------------
--pr_retorno_reajuste_definitivo_custo
-------------------------------------------------------------------------------
...
--                   pelo usuário
--Data             : 21/02/2005
--Atualizado       : 20.11.2008 - Preço de Custo
--------------------------------------------------------------------------------------------------
create procedure pr_retorno_reajuste_definitivo_custo
@ic_parametro     int = 0,
@dt_base          datetime,
...
begin
  ...
  update
    Produto_Custo
  set
    vl_custo_produto = vl_historico_produto
  from
