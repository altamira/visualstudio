...
create procedure pr_consulta_ordem_servico_grafica_cliente_canhoto      
@dt_inicial     datetime,      
@dt_final        datetime,      
@cd_nota_saida   int      
      
as       
--select cd_serie_nota, * from nota_saida      
  select  
    n.cd_serie_nota,      
    n.*,      
    vn.nm_vendedor,         
...
--exec pr_consulta_ordem_servico_grafica_cliente_canhoto  @dt_inicial = '2009/01/20', @dt_final = '2009/08/25', @cd_nota_saida = 0    
