...
create procedure pr_arquivo_invoice_china
...
--  Where pi.cd_identificacao_pedido = @cd_identificacao_pedido
...
/*  Select @cd_origem_padrao = cd_origem_importacao,
  ...
  Else
	  Insert into Arquivo_Texto_Invoice_Item (ic_produto_diferente, ic_produto_cadastrado, ic_quantidade_diferente,
	                                          ...
	                                          cd_produto, cd_importador, cd_fornecedor)
...
--------------------------------------------------------------------------
--exec pr_atualiza_arquivo_invoice_china
