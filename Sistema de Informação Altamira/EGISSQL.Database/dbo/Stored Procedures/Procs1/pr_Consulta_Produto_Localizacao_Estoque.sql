...
CREATE PROCEDURE pr_Consulta_Produto_Localizacao_Estoque
...
BEGIN
   ...
   where
	...
	#Produto_Grupo_Localizacao.cd_produto = pl.cd_produto and
        #Produto_Grupo_Localizacao.cd_fase_produto = pl.cd_fase_produto
