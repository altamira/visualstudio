...
--
------------------------------------------------------------------------------
create procedure pr_baixa_automatica_documento_implantacao_vencimento
@dt_inicial datetime = '',
@dt_final   datetime = ''
...
where
  cd_documento_receber in ( select cd_documento_receber from #documento_receber_pagamento )
