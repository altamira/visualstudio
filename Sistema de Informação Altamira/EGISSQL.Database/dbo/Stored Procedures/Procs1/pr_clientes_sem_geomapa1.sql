...
/****** Object:  Stored Procedure dbo.pr_clientes_sem_geomapa1    Script Date: 13/12/2002 15:08:15 ******/

CREATE PROCEDURE pr_clientes_sem_geomapa1
...
where (c.cd_vendedor between @cd_vendedor_inicial and
       ...
       substring(c.cd_cep,1,5) >= '01000' AND 
       substring(c.cd_cep,1,1) =  '0'     AND
       c.nm_divisao_area is null
