...
CREATE procedure pr_consulta_pedido_exportador_aberto
-----------------------------------------------------------------------------------
--pr_consulta_pedido_exportador_aberto
-----------------------------------------------------------------------------------
...
--Objettivo               : Pedidos em aberto por Exportador
--Data                    : 21/02/2007
--Atualizado              : 
----------------------------------------------------------------------------------------------------------
@cd_parametro  int      = 1,
...
as
  ...
  where
   ...
   (pvi.dt_cancelamento_item is null or
    ...
    isnull(pv.cd_exportador,0) = case when isnull( @cd_exportador,0 )=0 then isnull(pv.cd_exportador,0) else @cd_exportador end
