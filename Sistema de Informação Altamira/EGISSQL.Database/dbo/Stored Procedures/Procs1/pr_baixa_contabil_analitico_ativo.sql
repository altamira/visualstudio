...
-------------------------------------------------------------------------------
--pr_baixa_contabil_analitico_ativo
-------------------------------------------------------------------------------
...
--Data             : 18.01.2007
------------------------------------------------------------------------------
create procedure pr_baixa_contabil_analitico_ativo
@dt_inicial   datetime = '',
@dt_final     datetime = '',
@cd_conta     int      = 0
as
...
where
  pc.cd_conta = case when @cd_conta = 0 then pc.cd_conta else @cd_conta end and
