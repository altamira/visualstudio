...
-------------------------------------------------------------------------------
--sp_helptext pr_cliente_cobranca_contato
-------------------------------------------------------------------------------
...
-- 06.12.2010 - Clientes para Cobrança / Boleto - Carlos Fernandes
--------------------------------------------------------------------------------------------------
create procedure pr_cliente_cobranca_contato
@dt_inicial datetime,
@dt_final   datetime
as
...
where
  ...
  and
  isnull(cc.ic_cobranca_contato,'N') = 'S'
