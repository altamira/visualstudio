...
/****** Object:  Stored Procedure dbo.pr_atualiza_produto_saldo_nota    Script Date: 13/12/2002 15:08:12 ******/

CREATE PROCEDURE pr_atualiza_produto_saldo_nota
...
-- Busca o Tipo de Calculo E/S
  begin
    ...
    from tipo_movimento_estoque tme
    where 
