...
-------------------------------------------------------------------------------
--sp_helptext pr_adiantamento_pendente
-------------------------------------------------------------------------------
--pr_adiantamento_pendente
-------------------------------------------------------------------------------
...
--
--Objetivo         : Consulta de Adiantamento Pendente
--Data             : 07.12.2010
--Alteração        : 
--
--
------------------------------------------------------------------------------
create procedure pr_adiantamento_pendente
@dt_inicial        datetime,
@dt_final          datetime,
...
where
  ...
  isnull(sa.cd_cartao_credito,0)=0   --Não pode entrar Cartão de Crédito
