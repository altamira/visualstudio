...
/****** Object:  Stored Procedure dbo.pr_clientes_sem_cep1    Script Date: 13/12/2002 15:08:15 ******/

CREATE PROCEDURE pr_clientes_sem_cep1
...
where (c.cd_vendedor between @cd_vendedor_inicial and
      ...
      (substring(c.cd_cep,1,5) >= '00' or
       substring(c.cd_cep,1,1) =  '0'  or
       c.cd_cep is null) 
