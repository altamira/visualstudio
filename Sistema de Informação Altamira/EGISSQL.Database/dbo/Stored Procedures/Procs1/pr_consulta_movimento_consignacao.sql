...
CREATE PROCEDURE pr_consulta_movimento_consignacao
---------------------------------------------------
--GBS - Global Business Solution	       2003
--Stored Procedure: Microsoft SQL Server       2000
--Autor(es)       : Johnny Mendes de Souza
--Banco de Dados  : EgisSQL
--Objetivo        : Consulta de Movimentação no Estoque por Produto e Consignação
--Data            : 25/02/2003
--Atualizado      : 
---------------------------------------------------
...
begin
  ...
  where 
    isnull(me.ic_consig_movimento,'N') = 'S' and
