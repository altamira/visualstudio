...
-------------------------------------------------------------------------------
--sp_helptext pr_calculo_comissao_faturamento_pagamento_interno
-------------------------------------------------------------------------------
...
-- 10.12.2010 - Frete - carlos
------------------------------------------------------------------------------
create procedure pr_calculo_comissao_faturamento_pagamento_interno
@cd_vendedor   int      = 0,
@dt_inicial    datetime = '',
@dt_final      datetime = '',
@cd_usuario    int      = 0
