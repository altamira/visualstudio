...
-------------------------------------------------------------------------------
--pr_ranking_cliente_anual_vendas
-------------------------------------------------------------------------------
...
--Objetivo         : Consulta do Ranking de Quantidade de Vendas por Cliente
--Data             : 02.05.2006
...
------------------------------------------------------------------------------
create procedure pr_ranking_cliente_anual_vendas_quantidade
@cd_ano          int      = 0,
