...
-------------------------------------------------------------------------------
--sp_helptext pr_previsao_comissao_faturamento_pagamento
-------------------------------------------------------------------------------
--pr_previsao_comissao_faturamento_pagamento
-------------------------------------------------------------------------------
...
-- 04.05.2010 - Previsão - Desenvolvimento  
-- 06.05.2010 - Ajuste do Processo de cálculo - Carlos Fernandes
-- 10.05.2010 - Somente os Documentos em Aberto - Carlos Fernandes
-- 09.11.2010 - Número da Nota Fiscal - Carlos Fernandes
----------------------------------------------------------------------------------
create procedure pr_previsao_comissao_faturamento_pagamento
@cd_vendedor int      = 0,
@dt_inicial  datetime = '',
@dt_final    datetime = '',
@cd_usuario  int      = 0
...
--Documentos com Baixas Prevista no Período
...
--      ns.cd_nota_saida,
      ...
      d.dt_vencimento_documento             as dt_base_comissao,            
...
--       tl.nm_tipo_liquidacao                    as 'Tipo_Liquidacao'
      ...
      'P'                                      as ic_tipo_comissao,
      cast('Previsão' as varchar(30))          as 'Tipo_Liquidacao'
