...
-------------------------------------------------------------------------------
--sp_helptext pr_deposito_prestacao_conta_funcionario
-------------------------------------------------------------------------------
--pr_deposito_prestacao_conta_funcionario
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------
create procedure pr_deposito_prestacao_conta_funcionario
@dt_inicial datetime = '',
@dt_final   datetime = '',
...
where
  ...
  where
    ...
    pc.dt_liberacao_prestacao is not null             and
