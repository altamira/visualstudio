...
--Alteração        : 
------------------------------------------------------------------------------
create procedure pr_migracao_altamira_Pedido_Venda

as

 --select * from pedido_venda_Item
 --select * from pedido_venda
 --delete from Processo_Padrao_Produto_Alteracao
 --delete from processo_padrao
 ...
 --delete from historico_pedido_venda
 delete from pedido_venda_item
 delete from pedido_venda
 --select * from pedido_venda

 --delete from Pedido_Venda_Item_Observacao
--  select * from DB_ALTAMIRA.DBO.ve_pedidos
