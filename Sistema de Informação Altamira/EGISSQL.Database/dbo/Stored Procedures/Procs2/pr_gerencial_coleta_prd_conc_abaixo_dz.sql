...
/****** Object:  Stored Procedure dbo.pr_gerencial_coleta_prd_conc_abaixo_dz    Script Date: 13/12/2002 15:08:32 ******/





CREATE     PROCEDURE pr_gerencial_coleta_prd_conc_abaixo_dz
--pr_gerencial_coleta_prd_conc_abaixo_dz
--------------------------------------------------------------------------------------
...
'p.nm_marca_produto as Marca, '+
'p.nm_Fantasia_produto Produto, '+
'cast(isnull(coi.qt_duzia_item_coleta,0) as decimal(16,0)) as Campo, '+
...
'coi.qt_duzia_item_coleta > 0'
exec(@SQL)


Select Distinct lp.*, rf.DuziaMed as CampoMed from lojasPreco lp
left outer join #ResultadoFInal rf
on ((rf.marca=lp.marca) and (rf.produto=lp.produto))
where lp.Campo < (rf.DuziaMed-(rf.DuziaMed*(@tolerancia/100)))
