...
Create procedure pr_ranking_produto_caixa
-----------------------------------------------------------------------------------  
...
if @cd_produto  <> 0 
  ...
  declare @qt_total_categ1 int  
  declare @vl_total_categ1 float  
    
  -- Total de Produtos  
  set @qt_total_categ1 = @@rowcount  
    
  -- Total de Vendas Geral por Produto  
  set @vl_total_categ     = 0  
  select @vl_total_categ1 = @vl_total_categ1 + venda  
  from  
    #Venda1
