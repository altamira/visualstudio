...
-------------------------------------------------------------------------------
--sp_helptext pr_ranking_grupo_cliente_faturamento_produto
-------------------------------------------------------------------------------
--pr_ranking_grupo_cliente_faturamento_produto
-------------------------------------------------------------------------------
...
--Objetivo         : Consulta do Faturamento por Ranking de Grupo de Cliente
--                   por produto/Faturamento
--Data             : 03.12.2009
--Alteração        : 12.05.2010 - Devolução - Carlos Fernadnes
--
--
------------------------------------------------------------------------------
create procedure pr_ranking_grupo_cliente_faturamento_produto
@dt_inicial       datetime = '',
@dt_final         datetime = '',
