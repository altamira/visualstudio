...
/****** Object:  Stored Procedure dbo.pr_gerencial_coleta_prd_conc_regiao    Script Date: 13/12/2002 15:08:33 ******/




--pr_gerencial_coleta_prd_conc_regiao
--------------------------------------------------------------------------------------
...
--Atualizado    : 
--------------------------------------------------------------------------------------
CREATE   procedure pr_gerencial_coleta_prd_conc_regiao
@ic_parametro char(1),
@dt_inicial datetime,
@dt_final   datetime
as
