...
/****** Object:  Stored Procedure dbo.pr_gerencial_coleta_prd_conc_abaixo    Script Date: 13/12/2002 15:08:32 ******/

CREATE     PROCEDURE pr_gerencial_coleta_prd_conc_abaixo
--pr_gerencial_coleta_prd_conc_abaixo
--------------------------------------------------------------------------------------
...
'p.nm_marca_produto as Marca, '+
'p.nm_Fantasia_produto Produto, '+
'cast(isnull(coi.vl_item_coleta,0) as decimal(16,2)) as Campo, '+
...
'coi.vl_item_coleta > 0'
exec(@SQL)


Select Distinct lp.*, rf.prcMed as CampoMed from lojasPreco lp
left outer join #ResultadoFInal rf
on ((rf.marca=lp.marca) and (rf.produto=lp.produto))
where lp.Campo < (rf.prcMed-(rf.prcMed*(@tolerancia/100)))
