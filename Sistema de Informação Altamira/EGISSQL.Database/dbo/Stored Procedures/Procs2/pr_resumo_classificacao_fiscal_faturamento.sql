...
-------------------------------------------------------------------------------
--sp_helptext pr_resumo_classificacao_fiscal_faturamento
-------------------------------------------------------------------------------
--pr_resumo_classificacao_fiscal_faturamento
-------------------------------------------------------------------------------
...
--Data             : 12.08.2009
--Alteração        : 
-- 03.06.2010 - Ajuste de Valores com a consulta de produtos em notas emitidas
--
------------------------------------------------------------------------------
create procedure pr_resumo_classificacao_fiscal_faturamento
@dt_inicial datetime = '',
@dt_final   datetime = ''
...
--   distinct
--   ns.cd_nota_saida,
--   cast( max( round(ns.vl_total,2) ) as decimal(25,2)) as total
-- from
--   nota_saida_item i                         with (nolock) 
--   inner join nota_saida ns                  with (nolock) on ns.cd_nota_saida             = i.cd_nota_saida
--   inner join classificacao_fiscal cf        with (nolock) on cf.cd_classificacao_fiscal   = i.cd_classificacao_fiscal
