...
create procedure pr_quantidade_pedido_vendeda_vendedor
@dt_inicial datetime,
@dt_final   datetime
as

declare @qt_vendedor_venda  int
declare @qt_pedido_vendedor int
...
select  
  @qt_pedido_vendedor = count(cd_pedido_venda)
from 
  vw_venda_bi
where 
  dt_pedido_venda between @dt_inicial and @dt_final
...
select 
  ...
  @qt_pedido_vendedor  as 'QtdPedido'
