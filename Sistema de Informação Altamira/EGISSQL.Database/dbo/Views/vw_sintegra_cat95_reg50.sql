...
select distinct
  ...
  IsNull(neir.pc_icms_reg_nota_entrada,0) as 'Aliquota',
  round(sum(IsNull(neir.vl_cont_reg_nota_entrada,0)),2)         as 'ValorTotal',
  round(sum(IsNull(neir.vl_bicms_reg_nota_entrada,0)),2)        as 'BaseCalculoICMS',
  round(sum(IsNull(neir.vl_icms_reg_nota_entrada,0)),2)         as 'ValorICMS',
  round(sum(IsNull(neir.vl_icmsisen_reg_nota_entr,0)),2)        as 'IsentaNaoTributada',
  round(sum(IsNull(neir.vl_icmsoutr_reg_nota_entr,0)),2)        as 'Outras'
from
...
group by
  ...
  IsNull(neir.pc_icms_reg_nota_entrada,0)
