CREATE view vw_dev_operacao_interestadual_reg51 as
...
select
  ...
  , round( SUM( nsi.vl_ipi ), 2 )             as 'ValorIPI'
  , round( SUM( nsi.vl_ipi_isento_item ), 2 ) as 'IsentaNaoTributada'
  , round( SUM( nsi.vl_ipi_outros_item ), 2 ) as 'Outras'
