CREATE TABLE [dbo].[Consulta_Item_Orcamento_Refrigeracao] (
    ...
    CONSTRAINT [PK_Consulta_Item_Orcamento_Refrigeracao] PRIMARY KEY CLUSTERED ([cd_consulta] ASC, [cd_item_consulta] ASC, [cd_item_orcamento] ASC, [cd_item_refrig] ASC) WITH (FILLFACTOR = 90)
);
