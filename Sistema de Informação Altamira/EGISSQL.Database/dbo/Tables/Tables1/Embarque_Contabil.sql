CREATE TABLE [dbo].[Embarque_Contabil] (
    ...
    CONSTRAINT [PK_Embarque_Contabil] PRIMARY KEY CLUSTERED ([cd_pedido_venda] ASC, [cd_embarque] ASC, [cd_item_contabil] ASC) WITH (FILLFACTOR = 90)
);
