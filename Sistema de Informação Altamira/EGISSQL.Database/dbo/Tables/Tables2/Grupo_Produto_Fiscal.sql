CREATE TABLE [dbo].[Grupo_Produto_Fiscal] (
    ...
    [nm_conta_liv_saida_grupo]  VARCHAR (10) NULL,
    [ic_isento_icms_grupo_prod] CHAR (1)     NULL,
    [cd_tipo_item]              INT          NULL,
    CONSTRAINT [PK_Grupo_Produto_Fiscal] PRIMARY KEY CLUSTERED ([cd_grupo_produto] ASC) WITH (FILLFACTOR = 90)
);
