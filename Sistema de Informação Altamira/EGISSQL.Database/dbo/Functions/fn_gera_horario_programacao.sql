...
Create FUNCTION fn_gera_horario_programacao
(
@hr_entrada      varchar(8),
@qt_hora_entrada float )      --Hora Decimal 

-----------------------------------------------------------------------------------------
--fn_gera_horario_programacao
-----------------------------------------------------------------------------------------
--GBS - Global Business Sollution                                                    2005
-----------------------------------------------------------------------------------------
...
--                 : 27.10.2007 - Verificação do Horário Final - Carlos Fernandes
------------------------------------------------------------------------------------------
RETURNS varchar(8)
...
--Máximo de Programação de Carga é 24 horas
