...
--Autor            : Daniel C. Neto.
--Objetivo         : Função para retornar a data previsão de entrada de um produto.
--Data             : 16/02/2005
...
-- 02.03.2009 - Ajustes Diversos - Carlos Fernandes 
--------------------------------------------------------------------------------------
CREATE  FUNCTION fn_dt_previsao_produto(@cd_produto int, @cd_fase_produto int, @qtd_requisitada float)
RETURNS Datetime
AS
BEGIN
   ...
   begin
         ...
         --Realiza as deduções afim de chegar na menor data prevista que atenda a quantidade
