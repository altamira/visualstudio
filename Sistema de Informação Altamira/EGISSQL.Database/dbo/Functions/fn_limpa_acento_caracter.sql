...
create FUNCTION fn_limpa_acento_caracter
(@tira_acento varchar(8000))
...
/*
  ...
  set @v = replace(@v,'î','i')
  set @v = replace(@v,'ï','i')	
  set @v = replace(@v,'ó','o') --- Nesse Tipo de Collation, o Sql Não Faz a Distinção Entre Letra Maiscula e Minuscula
  set @v = replace(@v,'ò','o')
  set @v = replace(@v,'õ','o')
  set @v = replace(@v,'ô','o')
  set @v = replace(@v,'ö','o')	
...
---------------------------------------------------------------------------------------
--SELECT dbo.fn_texto_padrao_nfe('Á/í#â@ô.%%%%%%%%%%%%%%%%%%***********ghghgas')
---------------------------------------------------------------------------------------
