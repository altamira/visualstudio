...
CREATE FUNCTION fn_composicao_carteira_pedidos()
RETURNS @Carteira TABLE
	( cd_produto int,
    qtde float,
    qtde_original float,
    cd_pedido_venda int ,
...
BEGIN
  ...
  insert into @tmpComposicao
    ...
    select
      ...
      0 as cd_produto_pai,
      pvi.cd_produto,
      sum(isnull( pvi.qt_saldo_pedido_venda, 0 )) as 'Qtde',
      1,
      p.cd_versao_produto,
  ...
  while ( @lsair_loop = 'N' ) begin
     ...
     if @@FETCH_STATUS = 0 begin
        ...
        -- Verifica se o Processo já foi lido e processado - ELIAS 22/04/2004
        ...
        begin
          ...
          -- Inserir o processo na lista dos já lidos - ELIAS
