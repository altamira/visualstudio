...
create function fn_limpa_mascara_cep
(@cnpj varchar(8000))
...
set @cnpj = cast(@cnpj as varchar(8))              -- Depois de limpar a mascara, reduz o numero de caracteres para 14

set @cnpj = replicate('0',8 - len(@cnpj)) + @cnpj  -- se o numero de caracteres for menor que 14, adiciona zeros a esquerda
