...
namespace SA.ORM.PetaPoco.WBCCAD
{
    ...
    public partial class Orcamento : Context.Record<Orcamento>  
    {
		...
		{ 
			get
			{
				return _Data_do_Cadastro;
			}
			set
			{
				_Data_do_Cadastro = value;
				MarkColumnModified("Data do Cadastro");
			}
		}
		DateTime? _Data_do_Cadastro;

        [Column("Data da Emissao")] 
		public DateTime? Data_da_Emissao 
		{ 
			get
			{
				return _Data_da_Emissao;
			}
			set
			{
				_Data_da_Emissao = value;
				MarkColumnModified("Data da Emissao");
			}
		}
		DateTime? _Data_da_Emissao;
