<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Agenda.aspx.cs" Inherits="SA.Web.Application.Agenda" %>
    ...
    <tr>
        ...
        <td align="left" valign="middle" class="style3" width="50%">
            <table style="width:100%;">
                ...
                <tr>
                    <td>
                        <strong style="font-size: large">Hora</strong></td>
                    <td>
                        <asp:DropDownList ID="HoraDropDownList" runat="server" style="font-size: large; font-weight: 700">
                ...
                <tr>
                    <td>
                        <strong style="font-size: large">Minuto</strong></td>
                    <td>
                        <asp:DropDownList ID="MinutoDropDownList" runat="server" style="font-size: large; font-weight: 700">
