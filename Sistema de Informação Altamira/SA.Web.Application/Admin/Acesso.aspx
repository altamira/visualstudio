<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acesso.aspx.cs" Inherits="SA.Web.Application.Admin.Acesso" %>
...
<body>
    ...
    <div class="main" align="center" style="background-color: #FFFFFF">
        ...
        <asp:Login ID="Login" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" 
            ...
            TitleText="Controle de Acesso" UserNameLabelText="Usuário:" 
            UserNameRequiredErrorMessage="Usuário é obrigatório" 
            Width="681px" PasswordRecoveryText="Não tem ou esqueceu a senha, clique aqui." 
