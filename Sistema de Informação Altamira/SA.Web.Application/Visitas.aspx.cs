...
namespace SA.Web.Application
{
    public partial class Visitas : System.Web.UI.Page
    {
        ...
        protected void NomeButtom_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                Util.AtualizaTitulo(TituloLabel, "Visitas com o nome do cliente iniciando com '" + NomeTextBox.Text.Trim() + "'", false);
                ...
                Command.CommandText = "[Representante].[Busca de Visitas por Nome]";
                ...
                VisitasGridView.DataSource = DataReader;
                VisitasGridView.DataBind();
        ...
        protected void NumeroButtom_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                Util.AtualizaTitulo(TituloLabel, "Visita número " + NumeroTextBox.Text, false);
                ...
                Command.CommandText = "[Representante].[Busca de Visitas por Número]";
        ...
        protected void MesButtom_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Util.AtualizaTitulo(TituloLabel, "Visitas deste Mês", false);
            ...
            Command.CommandText = "[Representante].[Busca de Visitas do Mes]";
        ...
        protected void SemanaButtom_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Util.AtualizaTitulo(TituloLabel, "Visitas desta Semana", false);
            ...
            Command.CommandText = "[Representante].[Busca de Visitas da Semana]";
        ...
        protected void DiaBottom_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Util.AtualizaTitulo(TituloLabel, "Visitas de Hoje", false);
            ...
            Command.CommandText = "[Representante].[Busca de Visitas do Dia]";
        ...
        protected void PeriodoButtom_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                Util.AtualizaTitulo(TituloLabel, String.Format("Visitas no período de {0} à {1}", DataInicial.ToShortDateString(), DataFinal.ToShortDateString()), false);
                ...
                Command.CommandText = "[Representante].[Busca de Visitas por Período]";
        ...
        protected void MesPassadoButtom_Click(object sender, ImageClickEventArgs e)
        {
            NumeroTextBox.Text = "";
            NomeTextBox.Text = "";

            Util.AtualizaTitulo(TituloLabel, "Visitas do Mês Passado", false);
            ...
            Command.CommandText = "[Representante].[Busca de Visitas do Mes Passado]";
        ...
        protected void SemanaPassadaButtom_Click(object sender, ImageClickEventArgs e)
        {
            NumeroTextBox.Text = "";
            NomeTextBox.Text = "";

            Util.AtualizaTitulo(TituloLabel, "Visitas da Semana Passada", false);
            ...
            Command.CommandText = "[Representante].[Busca de Visitas da Semana Passada]";
        ...
        protected void IncluirAgendaButtom_Click(object sender, ImageClickEventArgs e)
        {
