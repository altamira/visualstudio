<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Visitas.aspx.cs" Inherits="SA.Web.Application.Visitas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table width="100%">
        <tr>
            ...
            <td align="center">
                <asp:ImageButton ID="SemanaPassadaButtom" runat="server" 
                    ImageUrl="~/Images/png/calendar-selection-week_4_48x48x32.png" 
                    onclick="SemanaPassadaButtom_Click" />
            </td>
            <td align="center">
                <asp:ImageButton ID="MesPassadoButtom" runat="server" 
                    ImageUrl="~/Images/png/calendar-selection-month_4_48x48x32.png" 
                    onclick="MesPassadoButtom_Click" />
            </td>
            <td align="center">
            ...
            <td align="center">
                <asp:HyperLink ID="HyperLink4" runat="server" ImageUrl="~/Images/png/Edit_4_48x48x32.png" NavigateUrl="~/Agenda.aspx">Pedidos</asp:HyperLink>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="9">
                <asp:Label ID="TituloLabel" runat="server" Font-Bold="True" Font-Size="Medium" 
                    Text="Visitas"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
    <asp:GridView ID="VisitasGridView" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="Número" 
                ...
                HeaderText="Número" Target="_blank" Visible="False">
            <ItemStyle Font-Bold="True" Font-Size="Medium" HorizontalAlign="Center" VerticalAlign="Top" Wrap="False" />
            </asp:HyperLinkField>
            <asp:HyperLinkField DataNavigateUrlFields="Identificador do Recado" 
                DataNavigateUrlFormatString="Recado.aspx?{0}" 
                DataTextField="Identificador do Recado" HeaderText="Recado" Target="_blank">
            <ItemStyle Font-Bold="True" Font-Size="Medium" HorizontalAlign="Center" 
                VerticalAlign="Top" />
            </asp:HyperLinkField>
            <asp:BoundField DataField="Data e Hora da Agenda" DataFormatString="{0}" 
                HeaderText="Data do Visita">
            ...
            <asp:BoundField DataField="DDD do Telefone" HeaderText="DDD">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Wrap="False" Font-Size="Small" />
            </asp:BoundField>
            <asp:BoundField DataField="Telefone" HeaderText="Telefone">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Wrap="False" Font-Size="Small" />
            </asp:BoundField>
            <asp:BoundField DataField="Ramal do Telefone" HeaderText="Ramal">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Wrap="False" Font-Size="Small" />
            </asp:BoundField>
            <asp:BoundField DataField="DDD do Celular" HeaderText="DDD">
            ...
            <asp:BoundField DataField="Observações da Agenda" HeaderText="Observação" >
            <ItemStyle Font-Size="Small" HorizontalAlign="Left" VerticalAlign="Top" />
            </asp:BoundField>
            <asp:HyperLinkField DataNavigateUrlFields="Número" 
                DataNavigateUrlFormatString="SolicitarOrcamento.aspx?{0}" HeaderText="Orçamento" 
                
                Text="&lt;img src=&quot;/Images/png/analysis_5_32x32x32.png&quot; border=&quot;0&quot; width=&quot;32&quot; height=&quot;32&quot; /&gt;" 
                Target="_blank">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" />
            </asp:HyperLinkField>
            <asp:HyperLinkField DataNavigateUrlFields="Número" 
                DataNavigateUrlFormatString="VisitaDeclinar.aspx?{0}" HeaderText="Declinar" 
