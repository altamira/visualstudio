<%@ Page Title="Orçamentos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Orcamentos.aspx.cs" Inherits="WebApplication1.orcamentos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table width="100%">
        ...
        <tr>
            ...
            <td align="center" valign="top">Busca Número do Orçamento</td>
            <td align="center" valign="top">Busca Nome do Cliente</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="6">
                <asp:Label ID="TituloLabel" runat="server" Font-Bold="True" Font-Size="Medium" Text="Orçamentos"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
    <asp:GridView ID="OrcamentosGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%">
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="Número" DataNavigateUrlFormatString="orcamento.aspx?{0}" DataTextField="Número" HeaderText="Número" Target="_blank">
            <ItemStyle Font-Bold="True" Font-Size="Medium" HorizontalAlign="Center" VerticalAlign="Top" Wrap="False" />
            </asp:HyperLinkField>
            <asp:BoundField DataField="Revisão" HeaderText="Rev.">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Wrap="False" Font-Bold="True" Font-Size="Small" />
            </asp:BoundField>
            <asp:HyperLinkField DataNavigateUrlFields="Número do Pedido de Venda" DataNavigateUrlFormatString="pedido.aspx?{0}" DataTextField="Número do Pedido de Venda" HeaderText="Pedido" Target="_blank">
            <ItemStyle Font-Bold="True" Font-Size="Medium" HorizontalAlign="Center" VerticalAlign="Top" Wrap="False" />
            </asp:HyperLinkField>
            ...
            <asp:BoundField DataField="Total" DataFormatString="{0:c}" HeaderText="Valor" >
            <ItemStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False" Font-Size="Small" />
            </asp:BoundField>
            <asp:BoundField DataField="Probabilidade de Fechamento em Percentual" DataFormatString="{0:p}" HeaderText="% Fechamento">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Size="Small" />
            </asp:BoundField>
            <asp:HyperLinkField DataNavigateUrlFields="Número" 
                DataNavigateUrlFormatString="~/Arquivos/Default.aspx?{0}" Target="_blank" 
                Text="&lt;img src=&quot;/Images/png/pdf-logo-small.png&quot; border=&quot;0&quot; width=&quot;32&quot; height=&quot;32&quot; /&gt;" />
            <asp:BoundField DataField="Última Atualização" DataFormatString="{0:d}" HeaderText="Última Atualização">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Size="Small" />
            </asp:BoundField>
            <asp:HyperLinkField DataNavigateUrlFields="Número" 
                DataNavigateUrlFormatString="Acompanhamento.aspx?{0}" 
                DataTextField="Situação Atual" HeaderText="Situação" Target="_blank" >
            <ItemStyle Font-Bold="True" Font-Size="Medium" HorizontalAlign="Center" 
                VerticalAlign="Top" Wrap="False" />
            </asp:HyperLinkField>
            <asp:BoundField DataField="Data do Próximo Contato" DataFormatString="{0:d}" 
                HeaderText="Próximo Contato">
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Font-Size="Small" />
            </asp:BoundField>
