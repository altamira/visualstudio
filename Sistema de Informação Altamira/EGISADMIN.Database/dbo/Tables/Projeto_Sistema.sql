CREATE TABLE [dbo].[Projeto_Sistema] (
    ...
    CONSTRAINT [FK_Projeto_Sistema_Cliente_Sistema] FOREIGN KEY ([cd_cliente_sistema]) REFERENCES [dbo].[Cliente_Sistema] ([cd_cliente_sistema]),
    CONSTRAINT [FK_Projeto_Sistema_Consultor_Implantacao] FOREIGN KEY ([cd_consultor]) REFERENCES [dbo].[Consultor_Implantacao] ([cd_consultor])
);
