...
where
  ...
  bd.nm_fantasia_banco_dados = 'EGISSQL'
order by
  t.nm_tabela,
  a.cd_atributo
...
--  print(@cSQL)
  ...
  declare @nm_atributo   varchar(40)
  ...
  begin
   ...
   set @sql = 'if exists (select '+@nm_atributo+' from '+@nm_tabela+' where '+@nm_atributo+' is null )'+
              ' begin '+
...
--   print(@sql)   
  ...
  select @cSQL = 'select cp.cd_tabela, cp.cd_atributo, t.nm_tabela, a.nm_atributo, a.ds_campo_help '+
