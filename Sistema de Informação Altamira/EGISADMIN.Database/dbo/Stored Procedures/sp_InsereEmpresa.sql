...
CREATE  procedure sp_InsereEmpresa
...
BEGIN
  ...
  SELECT @cd_empresa = ISNULL(MAX(cd_empresa),0) + 1 FROM Empresa TABLOCK
  INSERT INTO Empresa( cd_empresa,
               	nm_empresa,
               	nm_fantasia_empresa,
               	nm_endereco_empresa,
               	nm_bairro_empresa,
               	...
               	ds_cartorio_empresa,
               	nm_inscricao_municipal,
               	ic_plano_multi_lingua,
      	       	ic_email_ativo,
      	       	ic_fax_ativo,
      	       	ic_imprimelogotipo,
      	       	ic_imprimezebrado,
      	       	...
      	       	ic_imprimemensagem,
      	       	ds_mensagemrel,
      	       	ic_direcaomensagemrel,
      	       	qt_minutoOcioso,
               	vl_fat_minimo,
               	vl_lib_pedido_compra,
               	vl_tx_mensal_cust_fin,
               	qt_dias_uteis_env_ce,
               	qt_dias_nec_env_ce,
               	ic_grid_zebrado,
               	nm_FCgridzebrado,
               	nm_BCgridzebrado,
               	cd_seguro_porta_empresa,
               	cd_seguro_empresa,
               	cd_ftp_porta_empresa,
               	cd_ftp_empresa,
               	cd_http_porta_empresa,
               	cd_http_empresa,
               	ic_end_padrao_empresa,
               	cd_ip_porta_empresa,
               	cd_ip_empresa,
               	cd_smtp_porta_empresa,
               	cd_smtp_empresa,
               	pc_juro_nota_debito_emp,
               	vl_nota_debito_empresa,
               	cd_nota_debito_empresa,
               	pc_juro_empresa,
            		qt_mes_consumo_empresa,
            		ic_repnet_empresa,
            		ic_wapnet_empresa,
            		ic_credito_sac_empresa,
            		ic_prevfat_empresa,
            		cd_cnae,
            		cd_natureza_juridica,
            		ic_gera_serie_empresa,
            		ic_gera_lote_empresa,
            		ic_rastreabilidade_empres,
            		ic_iso_empresa,
            		ic_dica_empresa,
            		ic_ordsep_barra_empresa,
            		ic_ordsep_local_empresa,
            		qt_item_nota_empresa,
            		qt_servico_nota_empresa,
            		qt_pagreg_saida_empresa,
            		qt_pagreg_entrada_empresa,
            		ic_controla_desconto,
            		cd_serie_notent_empresa,
            		cd_serie_notsaida_empresa,
            		qt_servico_notent_empresa,
            		qt_item_notent_empresa,
            		ic_contrato_serv_empresa,
            		cd_tipo_numeracao_nota,
            		nm_banco_empresa,
            		ic_digita_usuario_empresa,
            		pc_irrf_serv_empresa,
               	ds_visao_empresa,
               	ds_missao_empresa,
               	cd_moeda,
               	ic_lembrete_empresa,
               	ds_qualidade_empresa,
               	qt_time_verif_ocorrencia,
               	qt_time_mostra_ocorrencia,
            		ic_acesso_internet_empresa,
                ic_pesq_credito_empresa,
            		ds_obs_empresa,
            		cd_reg_exercito_empresa,
            		dt_reg_exercito_empresa,
                ic_ocorrencia_empresa,
                cd_guia_trafego,
                cd_idioma,
                cd_porto,
                sg_pais_imp_empresa,
                sg_pedido_imp_empresa,
                cd_cliente_sistema,
                cd_numero,
                ...
                cd_registro_jucesp,
                ic_loja_empresa,
                pc_custo_capital_empresa,
					 ic_tipo_periodo_empresa,
                ic_fap_modelo_empresa,
                ic_video_empresa,
                ic_ativa_empresa,
                ic_multi_empresa,
                ic_restricao_usuario_empresa,
                ic_sintegra_empresa,
					 ic_implantacao_empresa,
					 cd_cep,
                cd_identifica_cep,
                cd_tipo_versao, 
					 ic_area_empresa, 
                ic_alfa_modulo_empresa,
                ic_unico_login_usuario, cd_senha_menu_empresa, nm_banco_origem,
                cd_iest_st_empresa, cd_suframa_empresa,
                ic_simples_empresa)
