...
if @cd_tipo_espessura_produto = 5 -- Manifold tratar como "Placa" de molde
   set @cd_tipo_espessura_produto = 3

if @cd_tipo_espessura_produto = 3 -- Placa : do quê ? Tratar como Molde/Base
begin
   if @nm_tipo_produto_espessura = 'MOLDE' or @nm_tipo_produto_espessura = 'PLACA'
