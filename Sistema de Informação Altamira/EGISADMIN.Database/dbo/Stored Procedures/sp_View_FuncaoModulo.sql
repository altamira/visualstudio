...
--Objetivo           :
--Data               : 13/12/2004
--Alteração          : Acerto do Cabeçalho - Sergio Cardoso
-------------------------------------------------------------------------------
create PROCEDURE [sp_View_FuncaoModulo]
@Modulo varchar(50),
...
--exec sp_View_FuncaoModulo 74, 'I'
--exec sp_View_FuncaoModulo 0, 'I'
