...
CREATE PROCEDURE [Representante].[Busca de Visitas por Nome]
...
BEGIN
	...
	VALUES (@Sessao, 'Busca de Visitas por Nome', @Nome, @@ROWCOUNT) 
...
GO
GRANT EXECUTE
    ON OBJECT::[Representante].[Busca de Visitas por Nome] TO [altanet]
    AS [dbo];
