...
/****** Object:  Stored Procedure dbo.SPCO_BOBINAPENDENTE_SELECIONA    Script Date: 23/10/2010 15:32:30 ******/

/****** Object:  Stored Procedure dbo.SPCO_BOBINAPENDENTE_SELECIONA    Script Date: 16/10/01 13:41:53 ******/
/****** Object:  Stored Procedure dbo.SPCO_BOBINAPENDENTE_SELECIONA    Script Date: 05/01/1999 11:03:42 ******/
CREATE PROCEDURE SPCO_BOBINAPENDENTE_SELECIONA
...
LEFT JOIN #DescricaoCredito ON  codc_Numero = coit_Numero      AND codc_Item   = coit_Item ,
    ...
    WHERE cope_Numero = coit_Numero
      ...
      AND SUBSTRING(coit_Produto, 1, 3) = 'WBO'
