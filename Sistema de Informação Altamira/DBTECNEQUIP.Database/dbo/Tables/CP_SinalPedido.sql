CREATE TABLE [dbo].[CP_SinalPedido] (
    ...
    [cpsp_DataProrrogacao] SMALLDATETIME NULL,
    ...
    [cpsp_Exclusao]        BIT           NOT NULL,
    [cpsp_Valida]          SMALLINT      NULL,
    [cpsp_Lock]            ROWVERSION    NOT NULL,
    CONSTRAINT [PK_CP_SinalPedido] PRIMARY KEY NONCLUSTERED ([cpsp_Sequencia] ASC) WITH (FILLFACTOR = 90)
);
