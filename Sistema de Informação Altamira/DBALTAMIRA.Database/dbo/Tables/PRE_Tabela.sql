CREATE TABLE [dbo].[PRE_Tabela] (
    ...
    [tab_Isento]           INT           NULL,
    CONSTRAINT [PK_PRE_Tabela] PRIMARY KEY NONCLUSTERED ([tab_NumeroTabela] ASC, [tab_CodProduto] ASC) WITH (FILLFACTOR = 90)
);
