...
/****** Object:  Stored Procedure dbo.SPCP_CONSCOPIACHEQUED_CONSULTA    Script Date: 23/10/2010 13:58:20 ******/


/****** Object:  Stored Procedure dbo.SPCP_CONSCOPIACHEQUED_CONSULTA    Script Date: 25/08/1999 20:11:53 ******/
CREATE PROCEDURE SPCP_CONSCOPIACHEQUED_CONSULTA
  ...
  -- Insere sinal de pedido
   ...
   END
    ...
    SELECT * FROM #TabConsulta
       ORDER BY DataPagamento, Referencia
