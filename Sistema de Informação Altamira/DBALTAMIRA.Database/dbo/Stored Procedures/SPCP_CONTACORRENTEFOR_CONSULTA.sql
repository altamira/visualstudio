...
/****** Object:  Stored Procedure dbo.SPCP_CONTACORRENTEFOR_CONSULTA    Script Date: 23/10/2010 13:58:20 ******/


/****** Object:  Stored Procedure dbo.SPCP_CONTACORRENTEFOR_CONSULTA    Script Date: 25/08/1999 20:11:54 ******/
...
BEGIN
    ...
    select cofc_Codigo,
        ...
        Where cofc_Codigo = @Fornecedor
          ...
          AND cpsp_DataVencimento BETWEEN @DataInicial AND @DataFinal
    

    SELECT * From #TabFornecedor order by cpnd_DataVencimento
