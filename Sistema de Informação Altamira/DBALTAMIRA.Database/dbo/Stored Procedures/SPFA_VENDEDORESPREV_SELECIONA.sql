...
/****** Object:  Stored Procedure dbo.SPFA_VENDEDORESPREV_SELECIONA    Script Date: 23/10/2010 13:58:21 ******/


/****** Object:  Stored Procedure dbo.SPFA_VENDEDORESPREV_SELECIONA    Script Date: 25/08/1999 20:11:56 ******/
CREATE PROCEDURE SPFA_VENDEDORESPREV_SELECIONA
...
BEGIN
   ...
   -- Insere os dados (por data da baixa)
...
--            AND crnd_Baixado = @Parametro	
   ...
   -- Insere os dados (por Títulos Vencidos e não pagos)
   INSERT INTO #TabVendedor ( Pedido,
                              NotaFiscal,
                              Cliente,
                              Parcela,
	...
	crnd_TipoNota
        ...
        FROM  VE_ClientesNovo,
           ...
           WHERE  crnd_DataVencimento < @DataInicial
