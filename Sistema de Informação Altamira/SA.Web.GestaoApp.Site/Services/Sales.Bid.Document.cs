...
namespace GestaoApp.Web.Services.Sales.Bid
{
    public class Document : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                #if DEBUG
                String FileName = string.Format("C:\\Users\\Administrador\\Documents\\orcamentos\\pdf-orca\\{0}.pdf", context.Request.QueryString[0].Split(',')[3]);
                #else
                String FileName = string.Format("C:\\Pastas Compartilhadas\\Departamentos\\Orcamento\\PDF-ORCA\\{0}.pdf", context.Request.QueryString[0].Split(',')[3]);
                #endif
