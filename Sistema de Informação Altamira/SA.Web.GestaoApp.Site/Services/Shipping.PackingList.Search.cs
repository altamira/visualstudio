...
namespace GestaoApp.Web.Services.Shipping.PackingList
{
    public class Search : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            SqlCommand cmd = new SqlCommand("Shipping.[PackingList.Search]");
            cmd.Connection = conn;
            ...
            cmd.Parameters.Add(session); cmd.Parameters.Add(session);
