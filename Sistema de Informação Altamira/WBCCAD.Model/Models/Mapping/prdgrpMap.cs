...
{
    public class prdgrpMap : EntityTypeConfiguration<prdgrp>
    {
        public prdgrpMap()
        {
            // Primary Key
            ...
            this.Property(t => t.PRDGRP_OPCAO_MATEXTRA)
                .IsFixedLength()
                .HasMaxLength(50);

            this.Property(t => t.PRDGRPLINHA)
                .HasMaxLength(50);
            ...
            this.Property(t => t.PRDGRP_OPCAO_MATEXTRA).HasColumnName("PRDGRP_OPCAO_MATEXTRA");
            this.Property(t => t.PRDGRPLINHA).HasColumnName("PRDGRPLINHA");
        }
    }
}
