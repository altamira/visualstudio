...
{
    public class OrcDetPadMap : EntityTypeConfiguration<OrcDetPad>
    {
        public OrcDetPadMap()
        {
            // Primary Key
            this.HasKey(t => new { t.numeroOrcamento, t.ORCDET_COUNTER });
            ...
            this.Property(t => t.ORCDET_COUNTER)
