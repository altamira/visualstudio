...
{
    public class arm_piso_acessorios_GEN_Map : EntityTypeConfiguration<arm_piso_acessorios_GEN_>
    {
        public arm_piso_acessorios_GEN_Map()
        {
            // Primary Key
            this.HasKey(t => new { t.para_piso_intermediario, t.tratar_como_piso, t.Aces_des_por_Pontos });
            ...
            this.ToTable("arm_piso_acessorios_GEN$");
