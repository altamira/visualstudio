...
{
    public class TABLES_AND_COLUMNS_VIEWMap : EntityTypeConfiguration<TABLES_AND_COLUMNS_VIEW>
    {
        public TABLES_AND_COLUMNS_VIEWMap()
        {
            // Primary Key
            ...
            this.ToTable("TABLES AND COLUMNS VIEW");
            ...
            this.Property(t => t.RECORD_COUNT).HasColumnName("RECORD_COUNT");
