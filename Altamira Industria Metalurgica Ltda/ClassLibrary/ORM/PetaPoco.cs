...
namespace SA.Data.ORM.PetaPoco
{
    ...
    public class Database : IDisposable
    {
        ...
        void AddParam(IDbCommand cmd, object item, string ParameterPrefix)
        {
            ...
            else
            {
                ...
                else if (item.GetType().Name == "Medida") // DataTypes.Medida
                {
                    p.GetType().GetProperty("UdtTypeName").SetValue(p, "medida", null); //geography is the equivalent SQL Server Type
                    p.Value = item;
                }
                else
                {
