<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Visitas.aspx.cs" Inherits="ALTANet.Visitas" %>
...
&nbsp;</td>
    ...
    <asp:GridView ID="VisitasGridView" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Data e Hora da Visita" DataFormatString="{0}" 
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Número" 
                DataNavigateUrlFormatString="OrcamentoNovo.aspx?{0}" HeaderText="Orçamento" 
