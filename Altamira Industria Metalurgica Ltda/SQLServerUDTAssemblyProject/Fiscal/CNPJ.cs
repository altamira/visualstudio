...
namespace SA.Data.Types.Fiscal
{
    ...
    //[CLSCompliant(false)]
    public sealed class CNPJ : INullable, IBinarySerialize
    {
        ...
        public static CNPJ Null { get { return new CNPJ(); } }
        ...
        public static CNPJ Parse(SqlString s)
        {
            if (s.IsNull)
                return Null;

            // Parse input String to separate out points.
            CNPJ g = new CNPJ(s.ToString().Trim());
