...
namespace SA.Data.Types.Fiscal
{
    ...
    //[CLSCompliant(false)]
    public sealed class Suframa : INullable, IBinarySerialize
    {
        ...
        public static Suframa Null { get { return new Suframa(); } }
        ...
        public static Suframa Parse(SqlString s)
        {
            if (s.IsNull)
                return Null;

            // Parse input String to separate out points.
            Suframa g = new Suframa(s.ToString().Trim());
