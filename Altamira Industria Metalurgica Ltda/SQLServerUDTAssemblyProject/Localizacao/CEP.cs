...
namespace SA.Data.Types.Localizacao
{
    ...
    //[CLSCompliant(false)]
    public sealed class CEP : INullable, IBinarySerialize
    {
        ...
        public static CEP Null { get { return new CEP(); } }
        ...
        public static CEP Parse(SqlString s)
        {
            if (s.IsNull)
                return Null;

            // Parse input String to separate out points.
            CEP g = new CEP(s.ToString().Trim());
